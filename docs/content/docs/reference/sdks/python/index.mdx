...
| Attribute | Page |
| --- | --- |
| `client.environments` | [Environments](/docs/reference/sdks/python/environments) |
| `client.hosts` | [Hosts](/docs/reference/sdks/python/hosts) |
| `client.snapshots` | [Snapshots](/docs/reference/sdks/python/snapshots) |
| `client.api_keys` | [API keys](/docs/reference/sdks/python/api-keys) |
...
[Quickstart](/docs/reference/sdks/python/quickstart) for a complete working
example, and [Errors](/docs/reference/sdks/python/errors) for how failures surface.
